    ...
    <div className="flex flex-col gap-y-7 p-7">
      <div className="flex flex-wrap justify-center">
        <div className="h-36 w-1/2 sm:w-1/3 md:w-1/6 flex items-center justify-center">
          <img src="/assets/rails.svg"
                ...
                style={{
                  filter: 'invert(15%) sepia(89%) saturate(4717%) hue-rotate(350deg) brightness(77%) contrast(124%)',
                  top: -10,
                }}
      ...
      <div className="flex flex-wrap justify-center">
        <div className="h-28 w-1/2 sm:w-1/3 md:w-1/6 flex justify-center items-center"
              title="node.js">
          <img src="/assets/nodejs.png" alt="node.js" className="h-20" />
        </div>
        ...
        <div className="h-28 w-1/2 sm:w-1/3 md:w-1/6 flex justify-center items-center"
              title="Vue.js">
          <img src="/assets/vuejs.png" alt="Vue.js" className="h-20" />
        </div>
        <div className="h-28 w-1/2 sm:w-1/3 md:w-1/6 flex justify-center items-center"
              title="Rust">
          <img src="/assets/rust.png" alt="Rust" className="h-16" />
        </div>
        <div className="h-28 w-1/2 sm:w-1/3 md:w-1/6 flex justify-center items-center"
              title="Java">
          <img src="/assets/java.png" alt="Java" className="h-16" />
        </div>
        <div className="h-28 w-1/2 sm:w-1/3 md:w-1/6 flex justify-center items-center"
              title=".NET">
          <img src="/assets/dotnet.png" alt=".NET" className="h-10" />
        </div>
      </div>
    </div>
  </div>
